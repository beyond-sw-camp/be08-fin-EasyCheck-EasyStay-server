package com.beyond.easycheck.notices.exception;
...
public enum NoticesMessageType implements MessageType {
    ...
    NOTICES_NOT_FOUND("Notices not found", HttpStatus.NOT_FOUND),
